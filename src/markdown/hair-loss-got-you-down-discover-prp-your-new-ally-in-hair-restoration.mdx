export const metadata = {
  ...
  image: "/procedure/hair-restoration/female-hairline-confidence.webp",
  imageAlt: "Woman calmly noticing subtle hair thinning near a softly lit window before PRP hair restoration consultation.",
  date: "2023-05-27",
